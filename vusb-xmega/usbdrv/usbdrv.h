...
#define usbDeviceConnect()      (PORTD.PIN6CTRL = PORT_OPC_PULLUP_gc)
#define usbDeviceDisconnect()   (PORTD.PIN6CTRL = PORT_OPC_TOTEM_gc)
#else	/* XMEGA */
...
#define USB_INTFLAGSPORT(name)		USB_CONCAT3(VPORT, name, _INTFLAGS)
...
#define USBOUT          USB_OUTPORT(USB_CFG_VPORTNAME)
#define USB_PULLUP_OUT  USB_OUTPORT(USB_CFG_PULLUP_IOPORTNAME)
#define USBIN           USB_INPORT(USB_CFG_VPORTNAME)
#define USBDDR          USB_DDRPORT(USB_CFG_VPORTNAME)
...
#   define USB_INTR_PENDING_BIT VPORT_INT0IF_bm
#endif
